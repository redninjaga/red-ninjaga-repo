...
def stars_time(get_time, arr, level, money):
...
while run:
    ...
    if score >= lvl_score[level_now - 1]:
        ...
        stars_time(all_time, star_second, level_now, money)
    ...
    draw_text(screen, str(money), "gold", 35, width - 30, height - 40)
    screen.blit(money_image, (width - 70, height - 32))
